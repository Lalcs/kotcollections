...
from kotcollections.interfaces import KotlinList
from kotcollections.extensions import KotlinListExtensions
...
class KotList(KotlinList[T], KotlinListExtensions[T]):
